from utils.common.generate_subset_jp_full import action_generate_subset_jp_full


def test_action_generate_subset_jp_full_output(tmp_path):
    """
    ...
    action_generate_subset_jp_full(
